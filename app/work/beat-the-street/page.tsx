        ...
        <div className="mx-auto max-w-7xl px-6 md:px-12">
          ...
          >
            ...
            <div className="flex flex-col gap-4 md:w-2/3">
              <video src="/bts-display-728x90.mp4" autoPlay muted loop playsInline className="w-full rounded-xl" />
              <video src="/bts-display-300x600.mp4" autoPlay muted loop playsInline className="rounded-xl" style={{ width: 150, height: 300, objectFit: "cover" }} />
            </div>
            {/* Social story */}
            <div className="flex justify-center md:w-1/3">
              <img
                ...
                className="w-full rounded-2xl md:w-auto md:max-w-[200px]"
              />
            </div>
          </motion.div>
